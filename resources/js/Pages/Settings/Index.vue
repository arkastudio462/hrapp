    ...
    <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
        ...
        <form class="mt-8 space-y-6" @submit.prevent="submit">
            ...
            <div class="rounded-2xl border border-slate-100 shadow-sm bg-white p-6">
                ...
                <div class="mt-4 space-y-4">
                    <div>
                        ...
                        <input v-model="form.company_name" type="text" class="mt-1.5 block w-full rounded-full border border-stone-300 bg-white px-5 py-3 text-ink outline-none focus:border-sky-600" />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-ink">Alamat</label>
                        <textarea v-model="form.address" rows="2" class="mt-1.5 block w-full rounded-xl border border-stone-300 bg-white px-5 py-3 text-ink outline-none focus:border-sky-600" />
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input v-model="form.npwp" type="text" class="mt-1.5 block w-full rounded-full border border-stone-300 bg-white px-5 py-3 text-ink outline-none focus:border-sky-600" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="mt-4 space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input v-model="form.work_start" type="time" class="mt-1.5 block w-full rounded-full border border-stone-300 bg-white px-5 py-3 text-ink outline-none focus:border-sky-600" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-ink">Jam Pulang</label>
                            <input v-model="form.work_end" type="time" class="mt-1.5 block w-full rounded-full border border-stone-300 bg-white px-5 py-3 text-ink outline-none focus:border-sky-600" />
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-ink">Toleransi Keterlambatan (menit)</label>
                            <input v-model="form.late_tolerance" type="number" min="0" class="mt-1.5 block w-full rounded-full border border-stone-300 bg-white px-5 py-3 text-ink outline-none focus:border-sky-600" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-ink">Radius Geofence (meter)</label>
                            <input v-model="form.geofence_radius" type="number" min="50" max="500" class="mt-1.5 block w-full rounded-full border border-stone-300 bg-white px-5 py-3 text-ink outline-none focus:border-sky-600" @input="updateCircle" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-2xl border border-slate-100 shadow-sm bg-white p-6">
                ...
                <div ref="mapContainer" class="mt-4 h-[300px] overflow-hidden rounded-2xl border border-slate-100 shadow-sm" />
                <div class="mt-4 grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-ink">Latitude</label>
                        <input v-model="form.office_latitude" type="number" step="any" class="mt-1.5 block w-full rounded-full border border-stone-300 bg-white px-5 py-3 text-ink outline-none focus:border-sky-600" />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-ink">Longitude</label>
                        <input v-model="form.office_longitude" type="number" step="any" class="mt-1.5 block w-full rounded-full border border-stone-300 bg-white px-5 py-3 text-ink outline-none focus:border-sky-600" />
                    </div>
                </div>
            </div>
            <!-- Leave Settings -->
            <div class="rounded-2xl border border-slate-100 shadow-sm bg-white p-6">
                ...
                <div class="mt-4 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input v-model="form.annual_leave" type="number" min="0" class="mt-1.5 block w-full rounded-full border border-stone-300 bg-white px-5 py-3 text-ink outline-none focus:border-sky-600" />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-ink">Cuti Sakit (hari/tahun)</label>
                        <input v-model="form.sick_leave" type="number" min="0" class="mt-1.5 block w-full rounded-full border border-stone-300 bg-white px-5 py-3 text-ink outline-none focus:border-sky-600" />
                    </div>
                </div>
            </div>
            <button
