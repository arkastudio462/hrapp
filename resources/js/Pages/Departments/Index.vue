            ...
            <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
                <div class="flex items-center gap-8">
                    ...
                    <nav class="hidden items-center gap-1 md:flex">
                        ...
                        <Link href="/departments" class="rounded-lg bg-stone-100 px-3 py-2 text-sm font-medium text-ink">Departemen</Link>
                ...
                <div v-if="departments.last_page > 1" class="mt-4 flex justify-center gap-1">
                    <Link
                        ...
                        :class="[
                            ...
                            page === departments.current_page ? 'bg-ink text-white' : 'text-inkmuted hover:bg-stone-100',
                        ]"
                    >
                        {{ page }}
                    </Link>
