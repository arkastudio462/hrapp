                    ...
                    <div class="rounded-xl border border-stone-200 bg-white p-6">
                        <div class="space-y-4">
                            <div>
                                ...
                                <input v-model="form.name" type="text" required class="mt-1.5 block w-full rounded-full border border-stone-300 bg-white px-5 py-3 text-ink outline-none focus:border-ink" placeholder="Contoh: Marketing" />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input v-model="form.budget" type="number" min="0" class="mt-1.5 block w-full rounded-full border border-stone-300 bg-white px-5 py-3 text-ink outline-none focus:border-ink" placeholder="0" />
                            </div>
                        </div>
                    </div>
