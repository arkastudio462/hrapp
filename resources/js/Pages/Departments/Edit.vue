                ...
                <div class="rounded-2xl border border-slate-100 shadow-sm bg-white p-6">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input v-model="form.budget" type="number" min="0" class="mt-1.5 block w-full rounded-full border border-stone-300 bg-white px-5 py-3 text-ink outline-none focus:border-sky-600" />
                        </div>
                    </div>
                </div>
                <button
