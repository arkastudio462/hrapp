        ...
        <div class="w-full max-w-md">
            <div class="rounded-3xl border border-slate-100 bg-white p-8 shadow-xl shadow-sky-900/5 sm:p-10">
                <div class="text-center">
                    ...
                    <h2 class="mt-6 text-2xl font-extrabold tracking-tight text-slate-900">Buat akun baru</h2>
                    <p class="mt-2 text-sm text-slate-500">Mulai kelola SDM perusahaan Anda secara gratis.</p>
                </div>
                ...
                <form class="mt-8 space-y-5" @submit.prevent="submit">
                    ...
                    <div class="text-center text-sm text-slate-500">
                        Sudah punya akun?
                        <Link href="/login" class="font-semibold text-sky-600 hover:text-sky-700">Masuk</Link>
                    </div>
                </form>
            </div>
        </div>
