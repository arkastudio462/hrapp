...
<template>
    ...
    <div class="min-h-screen bg-[#fafbff]">
        <div class="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
            ...
            <!-- Step Content -->
            <div class="mt-10 rounded-2xl border border-slate-100 shadow-sm bg-white p-6">
                ...
                <div v-if="step === 1">
                    ...
                    <form class="mt-6 space-y-4" @submit.prevent="submitStep1">
                        ...
                        <button
                            type="submit"
                            class="w-full rounded-full bg-sky-600 px-4 py-3 text-sm font-semibold text-white transition-colors shadow-md shadow-sky-500/25 hover:bg-moss-700 disabled:opacity-50"
                ...
                <div v-if="step === 2">
                    ...
                    <form class="mt-6 space-y-4" @submit.prevent="submitStep2">
                        ...
                        <div class="flex gap-3">
                            ...
                            <button
                                type="submit"
                                class="flex-1 rounded-full bg-sky-600 px-4 py-3 text-sm font-semibold text-white shadow-md shadow-sky-500/25 hover:bg-moss-700 disabled:opacity-50"
                            ...
                            <div class="mt-2 space-y-2">
                                <div v-for="(dept, i) in step3Form.departments" :key="i" class="flex gap-2">
                                    <input
                                        v-model="dept.name"
                                        type="text"
                                        class="flex-1 rounded-full border border-stone-300 bg-white px-5 py-2.5 text-sm text-ink outline-none focus:border-sky-600"
                            ...
                            <div class="mt-2 space-y-2">
                                <div v-for="(pos, i) in step3Form.positions" :key="i" class="flex gap-2">
                                    ...
                                    <input
                                        ...
                                        type="number"
                                        min="1"
                                        class="w-20 rounded-full border border-stone-300 bg-white px-3 py-2.5 text-sm text-ink outline-none focus:border-sky-600"
                                        placeholder="Level"
                                        required
                                    />
                                    <button
                ...
                <div v-if="step === 4">
                    ...
                    <form class="mt-6 space-y-6" @submit.prevent="submitStep4">
                        <div v-for="(emp, i) in step4Form.employees" :key="i" class="rounded-2xl border border-slate-100 shadow-sm p-4">
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        v-model="emp.name"
                                        type="text"
                                        class="mt-1 block w-full rounded-full border border-stone-300 bg-white px-4 py-2.5 text-sm text-ink outline-none focus:border-sky-600"
                                        required
                                    />
                                </div>
                                <div>
                ...
                <div v-if="step === 5">
                    ...
                    <div class="mt-6 space-y-4">
                        <div class="rounded-2xl border border-slate-100 shadow-sm p-4">
