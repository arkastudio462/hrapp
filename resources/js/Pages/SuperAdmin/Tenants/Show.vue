...
import { ArrowLeft, Users, Globe } from 'lucide-vue-next';
        ...
        <div class="rounded-2xl border border-slate-100 shadow-sm bg-white p-6">
            ...
            <div class="mt-4 flex flex-wrap gap-3">
                <button
                    ...
                    class="rounded-full bg-moss-600 px-4 py-2 text-sm font-semibold text-white transition-colors shadow-md shadow-sky-500/25 hover:bg-moss-700"
